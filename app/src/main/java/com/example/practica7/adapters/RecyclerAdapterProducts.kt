...
class RecyclerAdapterProducts(private val mList: List<Product>) : RecyclerView.Adapter<RecyclerAdapterProducts.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.recycler_element_products, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.nameTextView.text = ItemsViewModel.productName
